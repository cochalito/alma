                    ...
                    <div class="lg:col-span-2">
                        <div class="rounded-xl border border-border bg-card p-6 shadow-sm space-y-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <Input v-model="form.password" type="password" placeholder="Tu nueva contraseña" />
                                <p class="text-xs text-muted-foreground">Deja en blanco para conservar la actual. Mínimo 8 caracteres.</p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="rounded-xl border border-border bg-muted/30 p-4 text-sm space-y-2">
                            ...
                            <div class="flex justify-between text-xs">
                                ...
                                <span>{{ new Date(user.created_at).toLocaleDateString('es-VE') }}</span>
                            </div>
                        </div>
